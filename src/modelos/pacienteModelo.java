...
public class pacienteModelo {
  ...
  // Método estático para obtener la única instancia del modelo (patrón Singleton)
  ...
  // Método para notificar a todos los observadores cuando hay cambios en la lista
  // de pacientes
